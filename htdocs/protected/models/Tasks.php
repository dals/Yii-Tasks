...
class Tasks extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('ownerId, assigneeId, contextId', 'length', 'max' => 11),
            array('body, updatedOn, targetOn', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, subject, body, status, priority, createdOn, updatedOn, targetOn, repeatConditions, ownerId, assigneeId, assignedGroups, contextId', 'safe', 'on' => 'search'),
        );
    }
